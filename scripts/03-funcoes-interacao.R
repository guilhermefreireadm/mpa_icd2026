...
calcular_retorno(preco_atual = 32.00, preco_anterior = 30.80)
...
# Investimento de R$ 10,00 a 8% ao ano por 5 anos
calcular_valor_futuro(valor_presente = 10000, taxa = 0.08, periodos = 5)

# Usando o valor padrão de periodos (1 periodos)
calcular_valor_futuro(valor_presente = 10000, taxa = 0.08)

# Investimento de R$ 50000,00 a 12% ao ano por 10 anos
...
# Projeto: Máquina industrial de R$ 500.000,00
...
# Seleciona indicadores ROA ROE e Situação da empresa com base nos dados
resultado |> 
  select(roa, roe, situacao)
...
# Cria uma lista dentro de outra lista com um novo objeto criado das listas
projetos <- list(
  projeto_a = list(
...
# Calcuar a raiz quadrada de todos os números do vetor
# map_dbl : Exemplo 01
...
# Resumo da Simulação de MOnte Carlo
